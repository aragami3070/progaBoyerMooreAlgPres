...
- *Сканирование слева направо, сравнение справа налево*. Совмещается начало текста и шаблона, проверка начинается с последнего символа шаблона 
- *Правило плохого символа* (эврстика стоп символа)
- *Правило хорошего суфуфикса* (эвристика совпавшего суфуфикса)

$quote.angle.l$Шаблон$quote.angle.r$ --- подстрока, которую мы ищем.
...
#only("2")[Обратите внимание, для стоп-символа «D» последняя позиция будет 5, а не 7 --- последняя буква не учитывается. Это известная ошибка, приводящая к неоптимальности. Для алгоритма БМ она не фатальна из-за эвристики суффикса, но фатальна для упрощённой версии --- алгоритма БМ Хорспула. ] 
